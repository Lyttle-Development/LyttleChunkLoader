...
publishing {
    ...
    repositories {
        maven {
            name = "GitHubPackages"
            url = uri("https://maven.pkg.github.com/Lyttle-Development/LyttleNametag")
            credentials {
...
modrinth {
    ...
    projectId.set("lyttlenametag") // Replace with your Modrinth project slug or ID
